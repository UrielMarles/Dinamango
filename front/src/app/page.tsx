  ...
  return (
    ...
    <main className={style.main}>
      <section className={style.contenidoInicial}>
        ...
        <div>
          <Image className={style.img} src="/img/emprendedor.webp" alt="emprendedor" width={500} height={500} />
        </div>
      </section>
      
      <section className={style.contenidoMitad}>
      <div>
          <Image className={style.img} src="/img/hombreFeliz.webp" alt="Logo de la aplicación" width={450} height={450} />
        </div>
        <div className={style.textoMitad}>
          <p>Tu proxima oportunidad, con seguridad y confianza</p>
          <p>
            <Image src="/icons/check.webp" alt="Check" width={40} height={40} />
      ...
      <section className={style.contenidoFinal}>
        ...
        <div>
          <Image className={style.img} src="/img/trabajador.webp" alt="Trabajador" width={500} height={500} />
        </div>
      </section>
